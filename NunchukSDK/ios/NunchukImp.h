...
- (ObjMasterSigner *_Nullable)createPrimaryKeyWithName:(NSString *_Nonnull)name mnemonic:(NSString *_Nonnull)mnemonic passphrase:(NSString *_Nonnull)passphrase decoyPIN:(NSString *_Nonnull)decoyPIN error:(NSError  *_Nullable*_Nullable)outError;
...
- (NSDictionary *_Nullable)estimateRollOverAmount:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId tags:(NSArray *_Nonnull)tags collections:(NSArray *_Nonnull)collections feeRate:(long)feeRate useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error;
- (NSArray *_Nullable)draftRollOverTransactions:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId tags:(NSArray *_Nonnull)tags collections:(NSArray *_Nonnull)collections feeRate:(long)feeRate useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error;
- (NSArray *_Nullable)createRollOverTransactions:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId tags:(NSArray *_Nonnull)tags collections:(NSArray *_Nonnull)collections feeRate:(long)feeRate antiFeeSniping:(BOOL)antiFeeSniping useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error;
...
- (NSNumber *_Nullable)estimateRollOver11TransactionCount:(NSString *_Nonnull)walletId error:(NSError *_Nullable*_Nullable)error;
- (NSDictionary *_Nullable)estimateRollOver11Amount:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId feeRate:(long)feeRate useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error ;
- (NSArray *_Nullable)draftRollOver11Transactions:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId feeRate:(long)feeRate useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error;
- (NSArray *_Nullable)createRollOver11Transactions:(NSString *_Nonnull)sourceWalletId destinationWalletId:(NSString *_Nonnull)destinationWalletId feeRate:(long)feeRate antiFeeSniping:(BOOL)antiFeeSniping useScriptPath:(BOOL)useScriptPath error:(NSError *_Nullable*_Nullable)error;
